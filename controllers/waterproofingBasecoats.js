...
api.get("/", function (request, response) {
  response.render("waterproofing_basecoats/index.ejs");
});
//GET findall 
...
controllers/waterproofingBasecoats.js

http://127.0.0.1:8081/waterproofingBasecoat/findall [WORKING]

http://127.0.0.1:8081/waterproofingBasecoat/findone/1 [WORKING]

5 Response with CRUD Views:

http://127.0.0.1:8081/waterproofingBasecoat [WORKING]
http://127.0.0.1:8081/waterproofingBasecoat/create [WORKING]
http://127.0.0.1:8081/waterproofingBasecoat/delete/1 [WORKING]
http://127.0.0.1:8081/waterproofingBasecoat/details/1 [WORKING]
http://127.0.0.1:8081/waterproofingBasecoat/edit/1 [WORKING]

3 Response by executing CRUD actions:

http://127.0.0.1:8081/waterproofingBasecoat/save [FOUND]{on create new when click 'Post Entry' it will 
direct to the index, but not will create a new entry}
http://127.0.0.1:8081/waterproofingBasecoat/save/1 [WORKING]
